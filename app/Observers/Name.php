...
class Name
{
    ...
    public function created()
    {
        ...
        $json['boys'] = \App\Http\Resources\Name::collection(\App\Models\Name::whereIn('gender', ['boy', 'both'])->orderBy('id', 'ASC')->get());
        $json['girls'] = \App\Http\Resources\Name::collection(\App\Models\Name::whereIn('gender', ['girl', 'both'])->orderBy('id', 'ASC')->get());
        $json = str_replace(['\r', '\n'], '', json_encode($json));
        file_put_contents(
