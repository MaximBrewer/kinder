...
class Achieve
{
    ...
    public function created()
    {
        ...
        $json['achieves']['girls'] = \App\Http\Resources\Achieve::collection(\App\Models\Achieve::where('gender', 'girl')->get());
        $json['achieves']['boys'] = \App\Http\Resources\Achieve::collection(\App\Models\Achieve::where('gender', 'boy')->get());
        $json = str_replace(['\r', '\n'], '', json_encode($json));
        file_put_contents(
