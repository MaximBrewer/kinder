...
function Example(props) {
    ...
    return (
        <div className="promo-hny">
            <div className="h1">Такое волшебное поздравление получит ваш ребёнок!</div>
            <div style={{ maxWidth: "700px" }}>
                ...
                <div className={`text-center`}><Button onClick={props.toForm} text={`заполнить заявку`} style={{ display: "inline-block", padding: "11px 42px", textTransform: "uppercase" }} /></div>
            </div>
        </div>
    );
}
