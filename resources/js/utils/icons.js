...
export function Checked(props) {
    return (
        <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path d="M12 2.5H28C32.6944 2.5 36.5 6.30559 36.5 11V27C36.5 31.6944 32.6944 35.5 28 35.5H12C7.30557 35.5 3.49996 31.6944 3.49996 27V11C3.49996 6.30559 7.30558 2.5 12 2.5Z" fill="white" stroke="#E54C2E" strokeWidth="3" />
            <path fillRule="evenodd" clipRule="evenodd" d="M28.1781 12.4802L18.4769 22.0635L12.7841 16.4803C12.1414 15.8454 11.0995 15.8454 10.4569 16.4803C9.81418 17.1151 9.81418 18.1444 10.4569 18.7793L17.3175 25.5078C17.9602 26.1427 19.0021 26.1427 19.6447 25.5078L30.5054 14.7792C31.1481 14.1444 31.1481 13.1151 30.5054 12.4802C29.8627 11.8454 28.8208 11.8454 28.1781 12.4802Z" fill="#F04E21" />
        </svg>
    );
}
...
export function Close(props) {
    return (
        <svg viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path d="M25.5 2.50001C38.2025 2.50001 48.5 12.7974 48.5 25.5C48.5 38.2026 38.2025 48.5 25.5 48.5C12.7974 48.5 2.50006 38.2026 2.50006 25.5C2.50006 12.7974 12.7974 2.50001 25.5 2.50001Z" fill="white" stroke="#F04E21" strokeWidth="3" />
            <path fillRule="evenodd" clipRule="evenodd" d="M36.9086 17.4717C37.842 16.5383 37.842 15.0249 36.9086 14.0914C35.9751 13.1579 34.4617 13.1579 33.5283 14.0914L25.5 22.1197L17.4717 14.0914C16.5383 13.1579 15.0249 13.1579 14.0914 14.0914C13.1579 15.0249 13.1579 16.5383 14.0914 17.4717L22.1197 25.5L14.0914 33.5282C13.1579 34.4617 13.1579 35.9751 14.0914 36.9086C15.0249 37.842 16.5383 37.842 17.4717 36.9086L25.5 28.8803L33.5283 36.9086C34.4617 37.842 35.9751 37.842 36.9086 36.9086C37.842 35.9751 37.842 34.4617 36.9086 33.5282L28.8803 25.5L36.9086 17.4717Z" fill="#E54C2E" />
        </svg>
    );
}
...
export function Vk(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3333 1980" {...props}>
...
export function Lens(props) {
    return (
        <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <rect x="1.18994" y="1.36621" width="27.7042" height="27.7042" rx="13.8521" fill="white" stroke="#E4491F" strokeWidth="2" />
            <g clipPath="url(#clip0)">
                <path d="M17.7431 16.5325C19.4321 14.1475 18.8672 10.8449 16.4822 9.15632C14.0972 7.46772 10.7946 8.0322 9.10603 10.4176C7.41743 12.8026 7.98191 16.1048 10.3673 17.7934C12.0697 18.9986 14.3203 19.0914 16.1158 18.0311L20.0172 21.909C20.4384 22.3524 21.1393 22.3702 21.5827 21.9489C22.0261 21.5281 22.0439 20.8272 21.623 20.3838C21.6097 20.3697 21.5968 20.3568 21.5827 20.3434L17.7431 16.5325ZM13.4213 16.894C11.5366 16.8944 10.0086 15.3676 10.0074 13.4829C10.007 11.5982 11.5338 10.0702 13.4189 10.0694C15.3012 10.0686 16.8284 11.593 16.832 13.4753C16.8353 15.3604 15.3093 16.8908 13.4238 16.894C13.423 16.894 13.4225 16.894 13.4213 16.894Z" fill="#E4491F" />
            </g>
            <defs>
                <clipPath id="clip0">
                    <rect width="14.0704" height="14.0704" fill="white" transform="translate(8.00684 8.18311)" />
                </clipPath>
            </defs>
        </svg>
...
export function ArrowPrew(props) {
    return (
        <svg width="16" height="24" viewBox="0 0 16 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fillRule="evenodd" clipRule="evenodd" d="M0 12L16 0V24L0 12Z" fill="white" />
        </svg>
    );
}
export function ArrowNext(props) {
    return (
        <svg width="16" height="24" viewBox="0 0 16 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fillRule="evenodd" clipRule="evenodd" d="M16 12L0 0V24L16 12Z" fill="white" />
        </svg>
    );
}
export function ArrowDown(props) {
    return (
        <svg viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <path fillRule="evenodd" clipRule="evenodd" d="M1.69096 1.23673C1.33677 0.882496 0.762373 0.882496 0.408076 1.23673C0.0537961 1.59103 0.0537961 2.16538 0.408076 2.51967L6.39497 8.5066C6.74925 8.86088 7.32364 8.86088 7.67794 8.5066L13.6648 2.51967C14.0191 2.16538 14.0191 1.59103 13.6648 1.23673C13.3106 0.882496 12.7362 0.882496 12.3819 1.23673L7.03645 6.58222L1.69096 1.23673Z" fill="white" />
        </svg>
    );
}
...
export function ArrowPrewMobile(props) {
    return (
        <svg width="50" height="58" viewBox="0 0 50 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M48 54.9808L3 29L48 3.01924L48 54.9808Z" fill="#07A1F3" stroke="white" strokeWidth="3" />
        </svg>
    );
}
export function ArrowNextMobile(props) {
    return (
        <svg width="50" height="58" viewBox="0 0 50 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2 3.01924L47 29L2 54.9808L2 3.01924Z" fill="#07A1F3" stroke="white" strokeWidth="3" />
        </svg>
