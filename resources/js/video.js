...
var chooseBall = function(e) {
    ...
    player.tech({ IWillNotUseThisInPlugins: true }).hls.mediaSource.audioBuffer().remove();
    player.tech({ IWillNotUseThisInPlugins: true }).hls.mediaSource.videoBuffer().remove();
