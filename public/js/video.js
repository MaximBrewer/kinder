...
var player = videojs("video", {
  ...
  this.on("ended", function () {
    ...
    if (step == 3) {
      document.getElementById("photoFrame").style.transform = "scale(1.4)";
      document.getElementById("photoFrame").style.transition = "transform 10s linear";
      document.getElementById("photoFrameImg").src = "https://montage-cache.cdnvideo.ru/montage/kinder/part_viii/image.png";
      document.getElementById("photoFrame").style.backgroundRepeat = "no-repeat";
      document.getElementById("photoFrame").style.backgroundSize = "auto 92%";
      document.getElementById("photoFrame").style.backgroundPosition = "top left 57%";
      ...
      document.getElementById("photoFrame").addEventListener("touchstart", chooseBall); // document.getElementById("photoFrame").style.transform =
      //     "scale(2)";
  ...
  this.on("canplay", function () {
    if (step == 2) {
      setTimeout(function () {
        ...
        document.getElementById("photoFrame").style.transform = "scale(1)";
      }, photo_duration * 1000);
    }
